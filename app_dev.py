...
if "instrument_loaded" not in st.session_state or st.session_state.instrument_loaded != instrument:
    ...
    st.session_state.mono_h_blade = config.get("monochromator", {}).get("hfocus", False)
    st.session_state.mono_v_blade = config.get("monochromator", {}).get("vfocus", False)
    st.session_state.ana_h_blade = config.get("analyzer", {}).get("hfocus", False)
    st.session_state.ana_v_blade = config.get("analyzer", {}).get("vfocus", False)
